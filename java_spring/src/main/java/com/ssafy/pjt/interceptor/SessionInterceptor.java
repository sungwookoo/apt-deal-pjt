...
public class SessionInterceptor implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		}else if("/assets/login.html".equals(request.getServletPath()) ||
				 "/assets/join.html".equals(request.getServletPath()) ||
				 "/assets/findPassword.html".equals(request.getServletPath())) {
			return true;
		}
		else {
